// .wrangler/tmp/bundle-h3Ldro/checked-fetch.js
...
var app = new Hono2();
app.use("/*", module({ root: "./" }));
var BACKEND_URL = "https://alexanderthenotsobad.us/api/items";
app.get("/", (c) => {
  return c.html(`
    <!DOCTYPE html>
    <html lang="en">
...
// .wrangler/tmp/bundle-h3Ldro/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-h3Ldro/middleware-loader.entry.ts
