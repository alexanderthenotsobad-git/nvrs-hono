// .wrangler/tmp/bundle-wBbdSW/checked-fetch.js
...
var app = new Hono2();
app.use("/*", module({ root: "./" }));
var BACKEND_URL = "https://your-backend-url.com/api";
app.get("/", (c) => {
  return c.html(`
    <!DOCTYPE html>
    <html lang="en">
...
// .wrangler/tmp/bundle-wBbdSW/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-wBbdSW/middleware-loader.entry.ts
