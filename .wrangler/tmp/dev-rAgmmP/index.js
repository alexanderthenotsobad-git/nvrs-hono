// .wrangler/tmp/bundle-EtJR3E/checked-fetch.js
...
var app = new Hono2();
app.use("/*", module({ root: "./" }));
var BACKEND_URL = "https://alexanderthenotsobad.us/";
app.get("/employee", (c) => {
  return c.html(`
    <!DOCTYPE html>
    <html lang="en">
...
// .wrangler/tmp/bundle-EtJR3E/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-EtJR3E/middleware-loader.entry.ts
